...
func ioUringAllocHuge(entries uint, p *Params, sq *SubmissionQueue, cq *CompletionQueue,
...
func ioUringQueueInitParams(entries uint, ioUring *Ring,
	...
	if (p.Flags & SetupNoMmap) != 0 {
		ret = ioUringAllocHuge(entries, p, ioUring.sqRing, ioUring.cqRing,
			buf, buf_size)
		if ret < 0 {
			return ret
		}
...
//func ioUringQueueInitMem(entries uint, ioUring *Ring, p *Params, buf unsafe.Pointer, bufSize uint) uint {
//	p.Flags |= SetupNoMmap
//
//	return ioUringQueueInitParams(entries, ioUring, p, buf, bufSize)
//}

//// liburing: io_uring_queue_init_params - https://manpages.debian.org/unstable/liburing-dev/io_uring_queue_init_params.3.en.html
//func ioUringQueueInitParams(entries uint,ioUring *Ring, p *Params) uint {
//	return ioUringQueueInitParams(entries,ioUring, p, nil, 0)
//}

// liburing: io_uring_queue_init - https://manpages.debian.org/unstable/liburing-dev/io_uring_queue_init.3.en.html
//func ioUringQueueInit(entries uint,ioUring *Ring, flags uint32) uint {
//	params := &Params{
//		Flags: flags,
//	}
//
//	return ioUringQueueInitParams(entries,ioUring, params)
//}
